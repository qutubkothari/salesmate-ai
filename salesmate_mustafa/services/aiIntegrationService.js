    ...
    try {
      ...
      if (tenantId && context.phoneNumber) {
        try {
          ...
          console.log(`[AI_MEMORY] Retrieved ${conversationHistory.length} recent messages for AI fallback`);
        } catch (error) {
      ...
      console.log(`[AI_FALLBACK] Calling AI with ${conversationHistory.length} history messages`);
